...
public class BasketServiceTest {
    ...
    public void should_calculate_price_for_one_book() {
        assertEquals(50, basketService.calculatePrice(List.of(BOOKS_REPOSITORY.getFirst().getId())));
    }

    @Test
    @DisplayName("Should calculate price for two different books")
    public void should_calculate_price_for_two_different_books() {
        List<Integer> basket = List.of(BOOKS_REPOSITORY.get(0).getId(), BOOKS_REPOSITORY.get(1).getId());
        // (50 + 50) - 5% = 95
